...
def add_dns_rules(headers, zone_identifier, domain_name, IPv4, account_id, O365_sender):
    ...
    for i in range(5):
        ...
        content_list = [f"{IPv4}", "@", f"selector1-{cname_domain}-com._domainkey.abstraktmktg.onmicrosoft.com", 
            f"selector2-{cname_domain}-com._domainkey.abstraktmktg.onmicrosoft.com", f"v=DMARC1; p=none; pct=100; rua={O365_sender}; ruf=mailto:{O365_sender}; fo=1"]
